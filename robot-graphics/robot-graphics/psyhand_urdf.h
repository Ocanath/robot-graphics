...
/*fucking copypasta kludge hack. we're in it now boys*/
...
private:
	...
	const char* model_names[NUM_MODELS] = {
		"abh_models/wristmesh.STL",
		"abh_models/FB_palm_ref_MIR.STL",
		"abh_models/idx-F1.STL",
		"abh_models/idx-F2.STL",
...
public:
	...
	AbilityHandRightUrdf()
	{
		...
		palm.num_children = 5;
		jointlist_idx += palm.num_children;
		palm.joints[0].h_link = get_rpy_xyz_mat4(-1.1595426535897932, 1.284473, -1.0510016535897932, 9.49e-3, -13.04e-3, -62.95e-3);	//index q1
		palm.joints[0].child = &fl1[0];
		palm.joints[1].h_link = get_rpy_xyz_mat4(-1.2810616535897934, 1.308458, -1.2453756535897933, -9.653191e-3, -15.310271e-3, -67.853949e-3);	//middle q1
		palm.joints[1].child = &fl1[1];
		palm.joints[2].h_link = get_rpy_xyz_mat4(-1.424994653589793, 1.321452, -1.4657306535897934, -29.95426e-3, -14.212492e-3, -67.286105e-3);	//ring q1
		palm.joints[2].child = &fl1[2];
		palm.joints[3].h_link = get_rpy_xyz_mat4(-1.3764826535897934, 1.32222, -1.4832096535897932, -49.521293e-3, -11.004583e-3, -63.029065e-3);	//pinky q1
		palm.joints[3].child = &fl1[3];
		palm.joints[4].h_link = get_rpy_xyz_mat4(3.141592653589793, -0.0, -0.18884434641020664, 0, 0, 0);	//thumb_q1
		palm.joints[4].child = &tl1;
		...
		tl1.num_children = 1;
		jointlist_idx += tl1.num_children;
		tl1.joints[0].h_link = get_rpy_xyz_mat4(1.832595714594045, -0.0, 5.366520605522463e-18, 27.8283501e-3, 1.7436510745838653e-19, 14.7507e-3);
		tl1.joints[0].child = &tl2;
